...
Common labels
*/}}
{{- define "dokuta.labels" -}}
helm.sh/chart: {{ include "dokuta.chart" . }}
{{ include "dokuta.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "dokuta.selectorLabels" -}}
app.kubernetes.io/name: {{ include "dokuta.name" . }}
...
*/}}
{{- define "dokuta.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "dokuta.fullname" .) .Values.serviceAccount.name }}
{{- else }}
