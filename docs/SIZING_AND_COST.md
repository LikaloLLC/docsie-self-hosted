...
Record concurrent active users; concurrent imports and videos; pages and source-video hours per month; resolution and sampling cadence; generated speech characters; simultaneous voice calls; retention; and required completion latency. The free allowance of 10 workspace users and 25 named portal users does not imply capacity for 10 concurrent video jobs.
